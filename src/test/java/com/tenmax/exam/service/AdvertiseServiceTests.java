...
public class AdvertiseServiceTests {
    ...
    public void testParseFromJsonObject() {
        ...
        jsonObject = DeserializeJson.toObject(emptyJson);

        advertise = AdvertiseService.parseFromJsonObject(jsonObject);

        Assert.assertNull(advertise);
    }
}
